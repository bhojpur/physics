...
func (ListenRequestLogs) Descriptor() protoreflect.EnumDescriptor {
	return file_physics_proto_enumTypes[1].Descriptor()
}

func (ListenRequestLogs) Type() protoreflect.EnumType {
	return &file_physics_proto_enumTypes[1]
}
...
func (EngineTrigger) Descriptor() protoreflect.EnumDescriptor {
	return file_physics_proto_enumTypes[2].Descriptor()
}

func (EngineTrigger) Type() protoreflect.EnumType {
	return &file_physics_proto_enumTypes[2]
}
...
func (EnginePhase) Descriptor() protoreflect.EnumDescriptor {
	return file_physics_proto_enumTypes[3].Descriptor()
}

func (EnginePhase) Type() protoreflect.EnumType {
	return &file_physics_proto_enumTypes[3]
}
...
func (LogSliceType) Descriptor() protoreflect.EnumDescriptor {
	return file_physics_proto_enumTypes[4].Descriptor()
}

func (LogSliceType) Type() protoreflect.EnumType {
	return &file_physics_proto_enumTypes[4]
}
...
var file_physics_proto_rawDesc = []byte{
	...
	0x5f, 0x52, 0x45, 0x53, 0x55, 0x4c, 0x54, 0x10, 0x06, 0x32, 0xaa, 0x04, 0x0a, 0x0e, 0x50, 0x68,
	0x79, 0x73, 0x69, 0x63, 0x73, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x4c, 0x0a, 0x10,
	...
	0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x62, 0x68, 0x6f, 0x6a, 0x70, 0x75, 0x72, 0x2f, 0x70, 0x68, 0x79,
	0x73, 0x69, 0x63, 0x73, 0x2f, 0x70, 0x6b, 0x67, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x76, 0x31, 0x62,
...
var file_physics_proto_enumTypes = make([]protoimpl.EnumInfo, 5)
var file_physics_proto_msgTypes = make([]protoimpl.MessageInfo, 24)
...
var file_physics_proto_depIdxs = []int32{
	...
	5,  // 27: v1.PhysicsService.StartLocalEngine:input_type -> v1.StartLocalEngineRequest
	8,  // 28: v1.PhysicsService.StartFromPreviousEngine:input_type -> v1.StartFromPreviousEngineRequest
	7,  // 29: v1.PhysicsService.StartEngine:input_type -> v1.StartEngineRequest
	9,  // 30: v1.PhysicsService.ListEngines:input_type -> v1.ListEnginesRequest
	14, // 31: v1.PhysicsService.Subscribe:input_type -> v1.SubscribeRequest
	16, // 32: v1.PhysicsService.GetEngine:input_type -> v1.GetEngineRequest
	18, // 33: v1.PhysicsService.Listen:input_type -> v1.ListenRequest
	27, // 34: v1.PhysicsService.StopEngine:input_type -> v1.StopEngineRequest
	6,  // 35: v1.PhysicsService.StartLocalEngine:output_type -> v1.StartEngineResponse
	6,  // 36: v1.PhysicsService.StartFromPreviousEngine:output_type -> v1.StartEngineResponse
	6,  // 37: v1.PhysicsService.StartEngine:output_type -> v1.StartEngineResponse
	13, // 38: v1.PhysicsService.ListEngines:output_type -> v1.ListEnginesResponse
	15, // 39: v1.PhysicsService.Subscribe:output_type -> v1.SubscribeResponse
	17, // 40: v1.PhysicsService.GetEngine:output_type -> v1.GetEngineResponse
	19, // 41: v1.PhysicsService.Listen:output_type -> v1.ListenResponse
	28, // 42: v1.PhysicsService.StopEngine:output_type -> v1.StopEngineResponse
...
func file_physics_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_physics_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_physics_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_physics_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_physics_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
		...
		file_physics_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
		...
		file_physics_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
		...
		file_physics_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
		...
		file_physics_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
		...
		file_physics_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
		...
		file_physics_proto_msgTypes[15].Exporter = func(v interface{}, i int) interface{} {
		...
		file_physics_proto_msgTypes[16].Exporter = func(v interface{}, i int) interface{} {
		...
		file_physics_proto_msgTypes[17].Exporter = func(v interface{}, i int) interface{} {
		...
		file_physics_proto_msgTypes[18].Exporter = func(v interface{}, i int) interface{} {
		...
		file_physics_proto_msgTypes[19].Exporter = func(v interface{}, i int) interface{} {
		...
		file_physics_proto_msgTypes[20].Exporter = func(v interface{}, i int) interface{} {
		...
		file_physics_proto_msgTypes[21].Exporter = func(v interface{}, i int) interface{} {
		...
		file_physics_proto_msgTypes[22].Exporter = func(v interface{}, i int) interface{} {
		...
		file_physics_proto_msgTypes[23].Exporter = func(v interface{}, i int) interface{} {
	...
	file_physics_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	file_physics_proto_msgTypes[14].OneofWrappers = []interface{}{
